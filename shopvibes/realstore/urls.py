...
urlpatterns = [
    ...
    path('resetpassword/done/', auth_views.PasswordResetDoneView.as_view(template_name='realstore/resetpassword_done.html'), name='resetpassword_done'),

    path('resetpassword/confirm/<uidb64>/<token>/', auth_views.PasswordResetConfirmView.as_view(template_name='realstore/resetpassword_confirm.html', form_class = MyPasswordResetConfirmForm, success_url='/resetpassword_complete/'), name='resetpassword_confirm'),

    path('resetpassword/complete/', auth_views.PasswordResetCompleteView.as_view(template_name='realstore/resetpassword_complete.html'), name='resetpassword_complete'),
